...
### Тестовые данные:
Для производительностного тестирования использовалась матрица размером 2000×2000 (4 000 000 элементов).
...
Результаты производительностного тестирования для матрицы 2000×2000 в системе NIxOS 24.05:
...
2. Для матрицы размером 2000×2000 в системе NIxOS 24.05 не наблюдается значительного преимущества MPI реализации над последовательной
